...
/*                    c1 = new PdfPCell(new Phrase(al.process(reportEntity.getPost()), subFont));
                ...
                if (data.get(0) instanceof Person) {
                    for (T report : data) {
                        ...
                        PdfPCell c1;
                        if (reportEntity.getNationalCode() == null)
                            c1 = new PdfPCell(new Phrase(al.process(""), subFont));
                        else
                            c1 = new PdfPCell(new Phrase(al.process(reportEntity.getNationalCode()), subFont));
