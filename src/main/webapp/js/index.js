...
var Gregorian = {
	...
	jdays : ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'],
	jmonths_Mini : ['January','February','March','April','May','June','July','August','September','October','November','December'],
	
	jdays_Mini : ['Sun','Mon','Tue','Wed','Thu','Fri','Sat'],
	alphabetic : function(month){
		return this.jmonths[month-1];
	},
	GregorianDay : function(get){
		if(!get){
			var d = new Date();
			get = d.getDay();
		}
	...
	alphabetic_Mini : function(month){
		return this.jmonths_Mini[month-1];
	},
	GregorianDay_Mini : function(get){
		if(!get){
			var d = new Date();
			get = d.getDay();
		}
		return this.jdays_Mini[get];
	}
};
var Jalali = {
