...
(function (window) {
    ...
    var eventDetailsFunc = {
        ...
        key: function () {
            return (this.event.which || this.event.keyCode || this.event.charCode || 0);
        },
        shiftKey: function () {
            return typeof this.event.shiftKey === "undefined" ? this.event.shiftKey : this.key() === 16;
        },
        ctrlKey: function () {
            return typeof this.event.ctrlKey === "undefined" ? this.event.ctrlKey : this.key() === 17;
        },
        altKey: function () {
            return typeof this.event.altKey === "undefined" ? this.event.altKey : this.key() === 18;
        },
        metaKey: function () {
            return typeof this.event.metaKey === "undefined" ? this.event.metaKey : false;
        },
        objectX: function () {
...
colorToRgba.namedColorsPattern = function () {
    ...
    for (var o in colorToRgba.namedColors) {
        ...
        if (typeof v === "string") {
            b[b.length] = o;
            if (o.indexOf("gray") >= 0)b[b.length] = o.replace("gray", "grey");
        }
    }
