...
// Usage -- fAddEvent(year, month, day, message, adapter, bgcolor, fgcolor, bgimg, boxit, html);
// Notice:
// 1. The (year,month,day) identifies the date of the agenda.
// 2. In the adapter part you can use any javascript statement, or use " " for doing nothing.
// 3. Assign "null" value to adapter will result in a line-through effect(can't be selected).
...
// Finally you should return an agenda array like [message, adapter, bgcolor, fgcolor, bgimg, boxit, html]
